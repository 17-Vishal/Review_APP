...
const Review = ({ review, setCurrentId }) => {
    ...
    return (
        <Card className={classes.card}>
            <CardMedia className={classes.media} image={review.selectedFile || 'https://user-images.githubusercontent.com/194400/49531010-48dad180-f8b1-11e8-8d89-1e61320e1d82.png'} title={review.title} />
            ...
            <div className={classes.overlay2}>
                <Button style={{ color: 'white' }} size="small" onClick={() => setCurrentId(review._id)}><MoreHorizIcon fontSize="default" /></Button>
            </div>
            ...
            <CardContent>
                <Typography variant="body2" color="textSecondary" component="p">{review.review}</Typography>
            </CardContent>
